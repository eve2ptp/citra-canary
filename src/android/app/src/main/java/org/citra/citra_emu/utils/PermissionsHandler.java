...
public class PermissionsHandler {
    ...
    public static boolean checkWritePermission(FragmentActivity activity, ActivityResultLauncher<Integer> launcher) {
        if (isFirstBoot(activity)) {
            launcher.launch(R.string.select_citra_user_folder);
            return false;
        }
