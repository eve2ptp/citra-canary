...
ConfigureGeneral::ConfigureGeneral(QWidget* parent)
    ...
    // This has to be done before SetConfiguration is called for the text to change
    ui->emulation_speed_display_label->setText(tr("unthrottled"));
    ui->emulation_speed_display_label->setFixedWidth(ui->emulation_speed_display_label->width());
