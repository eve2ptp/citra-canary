...
constexpr u32 NUM_SYSTEM_TITLE_CATEGORIES = 7;
...
static const u64 home_menu_title_id_high = 0x00040030;
static const SystemTitle home_menu_title = {
    .name = "HOME Menu",
                 ...
                 .titles =
                     {
                         ...
                         },
                         {
                             .name = "NVer (O3DS)",
                             .sets = SystemTitleSet::Old3ds,
                             .title_id_lows = {0x00016102, 0x00016202, 0x00016302, 0x00016302,
                                               0x00016402, 0x00016502, 0x00016602},
                         },
                         {
                             .name = "NVer (N3DS)",
                             .sets = SystemTitleSet::New3ds,
                             .title_id_lows = {0x20016102, 0x20016202, 0x20016302, 0x20016302, 0,
                                               0x20016502, 0},
                         },
                         {
                             .name = "CVer",
                             .title_id_lows = {0x00017102, 0x00017202, 0x00017302, 0x00017302,
...
int GetSystemTitleRegion(u64 title_id) {
    ...
    for (const auto& title : category->titles) {
        for (int region = 0; region < NUM_SYSTEM_TITLE_REGIONS; region++) {
