...
protected:
     ...
     * @returns ResultCode Whether the operation was successful or not.
     */
    virtual ResultCode Start(const Service::APT::AppletStartupParameter& parameter) = 0;
    ...
    void CloseApplet(const std::shared_ptr<Kernel::Object>& object, const std::vector<u8>& buffer);
