...
NFC_M::NFC_M(std::shared_ptr<Module> nfc) : Module::Interface(std::move(nfc), "nfc:m", 1) {
    static const FunctionInfo functions[] = {
        ...
        {0x00170000, &NFC_M::GetRegisterInfo, "GetRegisterInfo"},
        {0x00180000, &NFC_M::GetCommonInfo, "GetCommonInfo"},
        ...
        // nfc:m
        {0x040100C2, &NFC_M::Format, "Format"},
        {0x04020000, &NFC_M::GetAdminInfo, "GetAdminInfo"},
        {0x04030000, &NFC_M::GetEmptyRegisterInfo, "GetEmptyRegisterInfo"},
        {0x04040A40, &NFC_M::SetRegisterInfo, "SetRegisterInfo"},
        {0x04050000, &NFC_M::DeleteRegisterInfo, "DeleteRegisterInfo"},
        {0x04060000, &NFC_M::DeleteApplicationArea, "DeleteApplicationArea"},
        {0x04070000, &NFC_M::ExistsApplicationArea, "ExistsApplicationArea"},
        // clang-format on
    };
